...
# On Vercel, static files are served by the CDN via public/ directory (build.sh).
# Do NOT wrap with WhiteNoise — it would intercept /static/* requests and
# compete with Vercel's filesystem handle, causing race conditions.
if not IS_VERCEL:
    import whitenoise
    ...
    sys.stderr.write('[index.py] Vercel mode: WhiteNoise disabled (using CDN)\n')
