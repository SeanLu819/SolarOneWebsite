...
_SIDEBAR_I18N = {
    ...
    # 缺失补录（2026-09-17）：_get_projects_sidebar 一直在请求这些标签，但字典里
    # 没有条目，_t() 静默回退英文 —— /projects/ 侧栏在五个语种里显示英文。
    'Karting Track':    {'fr': 'Circuit de Karting', 'es': 'Circuito de Karting', 'de': 'Kartbahn', 'ar': 'حلبة الكارتينج', 'ru': 'Картинговая трасса'},
    'Fencing':          {'fr': 'Escrime', 'es': 'Esgrima', 'de': 'Fechten', 'ar': 'المبارزة', 'ru': 'Фехтование'},
    'Aquatics Centre':  {'fr': 'Centre Aquatique', 'es': 'Centro Acuático', 'de': 'Wassersportzentrum', 'ar': 'مركز الرياضات المائية', 'ru': 'Центр водных видов спорта'},
    'Airports':         {'fr': 'Aéroports', 'es': 'Aeropuertos', 'de': 'Flughäfen', 'ar': 'المطارات', 'ru': 'Аэропорты'},
    'City Expressway':  {'fr': 'Autoroute Urbaine', 'es': 'Autopista Urbana', 'de': 'Stadtautobahn', 'ar': 'طريق سريع حضري', 'ru': 'Городская скоростная дорога'},
    ...
    # 缺失补录（2026-09-17）：seed_data.json 的 siteconfig.projects_title 就是
    # 'Featured Projects'，经 common.py 的 _t(config.projects_title, lang) 下发，
